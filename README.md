...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-crhu4uo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-crhu4uo.containers.anotherwebservice.com/
...
```
git clone git@github.com:rocketbunny23/container-crhu4uo.git
cd container-crhu4uo
```
...
```
docker attach container-crhu4uo
```
